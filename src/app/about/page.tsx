...
export default function About() {
  const [activeTab, setActiveTab] = useState('Work Laptops');

  const tabs = ['Work Laptops', 'Casual Laptops', 'Production Machine', 'Networking Equipment'];
  ...
  const deviceDetails = {
    ...
    'Production Machine': [
      ...
      { brand: 'Cooler Master', model: 'Hyper H412R', description: 'My computer fell once so picked up this guy.', url: 'https://www.mwave.com.au/product/cooler-master-hyper-h412r-cpu-cooler-ac48016' },
