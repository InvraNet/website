...
type Tab = 'Work Laptops' | 'Casual Laptops' | 'Production Machine' | 'Networking Equipment';

export default function About() {
  const [activeTab, setActiveTab] = useState<Tab>('Work Laptops');

  const tabs: Tab[] = ['Work Laptops', 'Casual Laptops', 'Production Machine', 'Networking Equipment'];
  ...
  const deviceDetails: DeviceDetails = {
    ...
    'Casual Laptops': [
      { brand: 'ASUS', model: 'Vivobook TP1400KA', description: 'Backup NFS, SMB, and AD.', url: 'https://www.asus.com/au/laptops/for-home/vivobook/vivobook-go-14-flip-tp1400/techspec/' }
    ],
    'Production Machine': [
      { brand: 'Intel', model: 'Core i5-10400', description: 'Picked a dumb CPU.', url: 'https://www.amazon.com.au/dp/B086MN38Q2' },
      { brand: 'Cooler Master', model: 'Hyper H412R', description: 'My computer fell once, so I picked up this guy.', url: 'https://www.mwave.com.au/product/cooler-master-hyper-h412r-cpu-cooler-ac48016' },
      { brand: 'MSI', model: 'Z490-A PRO', description: 'A terrible ATX motherboard for Linux. Deletes my Linux UEFI entry.', url: 'https://www.amazon.com.au/dp/B0876HPVHX' },
      { brand: 'G.Skill', model: 'Ripjaws V', description: '64GB (2 x 32GB kit) DDR4 RAM.', url: 'https://www.mwave.com.au/product/gskill-ripjaws-v-64gb-2x-32gb-ddr4-3200mhz-cl16-desktop-memory-black-ac29335' },
      { brand: 'Seagate', model: 'Barracuda Compute', description: '8 TB 3.5&quot; HDD, 5400 RPM.', url: 'https://www.mwave.com.au/product/seagate-st8000dm004-8tb-barracuda-35-sata3-desktop-hard-drive-ac12989' },
    ...
    'Networking Equipment': [
      { brand: 'Aussie Broadband', model: 'NBN RSP', description: 'Retail Service Provider of the ISP NBN, or Opticomm.', url: 'https://aussiebroadband.com.au/' },
      { brand: 'Arris', model: 'CM820B', description: 'NTD HFC NTD modem.', url: 'https://www.australiancomputertraders.com.au/nbn-hfc-connection-box-arris-touchstone-cm8200b-ca' },
      { brand: 'Ubiquiti Networks', model: 'UniFi Dream Machine Pro', description: 'All-in-one router and security gateway.', url: 'https://store.ui.com/us/en/pro/category/all-unifi-cloud-gateways/products/udm-pro' },
      { brand: 'TP-Link', model: 'TL-SG1005P', description: '5 Port PoE switch.', url: 'https://www.tp-link.com/au/business-networking/unmanaged-switch/tl-sg1005p/' },
      { brand: 'Ubiquiti Networks', model: 'U6-Lite', description: 'Access point for wireless networks.', url: 'https://store.ui.com/us/en/collections/unifi-wifi-flagship-compact/products/u6-lite' },
    ],
  };
